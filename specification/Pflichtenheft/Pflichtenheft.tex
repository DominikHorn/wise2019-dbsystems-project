...
\begin{usecase}
	...
	\addrow{M08}{...erst nach Abschluss einer Wahl diese statistisch Auszuwerten, e.g., um Wahlbeeinflussung oder timed-attacks auf das Wahlgeheimnis zu verhindern.}
	\addrow{M09}{Die Anwendung speichert Erst- und Zweitstimmen getrennt voneinander um das Wahlgeheimnis und Datenschutzaspekte zu respektieren.}
      \addrow{M10}{Das System beachtet alle relevanten gesetzlichen Vorgaben für bayrische Landtagswahlen}
\end{usecase}
...
Datenzugriffe erfolgen stets authentifiziert, gefiltert und werden protokolliert. 
%
...
\begin{center}
      \begin{tabular}{|m{4cm}|m{2.5cm}|m{8.5cm}|}
        ...
        \hline
        Frontend UI & React & React ist ein von Facebook entwickeltes UI-Framework und wird zur Darstellung sämtlicher Inhalte verwendet \\
        \hline
