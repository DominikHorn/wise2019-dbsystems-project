...
in einer frei zugänglichen Weboberfläche.
Das Eintragen von einer oder mehreren Stimmabgaben ist als GraphQL Mutation Aufruf
und damit als Backend Service für authentifizierte Nutzer zugänglich.
Zur Einzelstimmabgabe im Wahllokal wird ebenfalls eine Weboberfläche zugänglich gemacht,
die erst nach Freigabe durch eine(n) WahlhelferIn zur Abgabe von maixmal einer Erststimme
