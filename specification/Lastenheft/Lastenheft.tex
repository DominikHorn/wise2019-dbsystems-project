...
\begin{usecase}
  ...
  \addrow{FA01}{Wahldaten von Landtagswahlen ab (inklusive) 2013 müssen fehlerfrei importierbar und im System abbildbar sein}
  \addrow{FA02}{Einzelstimmen von Wahlberechtigen müssen über eine graphische Schnittstelle im Wahllokal eintragbar sein (E-Voting). 
...
\begin{usecase}
  \addheading{Nummer}{Beschreibung} 
  \addrow{NF01}{Das System muss alle rechtlichen Vorgaben zur Landtagswahl im Freistaat Bayern einhalten,
                insbesondere im Bezug auf Datenschutz und Wahlgeheimniss}
